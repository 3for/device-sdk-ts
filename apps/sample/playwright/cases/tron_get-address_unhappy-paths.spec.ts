...
test.describe("TRON Signer: get address, unhappy paths", () => {
  test.beforeEach(async ({ page }) => {
    await page.goto("http://localhost:3000/");
  });

  test("device should return an error for malformed derivation paths", async ({
    page,
  }) => {
    ...
    await test.step("Then execute TRON: get address with malformed derivation paths", async () => {
