...
export type ProvideEnumValueCommandArgs = {
  readonly data: Uint8Array;
  readonly isFirstChunk: boolean;
};

export class ProvideEnumValueCommand
  implements Command<void, ProvideEnumValueCommandArgs, TronErrorCodes>
{
  readonly name = "ProvideEnumValue";
  private readonly errorHelper = new CommandErrorHelper<void, TronErrorCodes>(
    TRON_APP_ERRORS,
    TronAppCommandErrorFactory,
  );

  constructor(private readonly args: ProvideEnumValueCommandArgs) {}

  getApdu(): Apdu {
    const apduArgs: ApduBuilderArgs = {
      cla: LEDGER_CLA,
      ins: INS.PROVIDE_ENUM_VALUE,
